...
CRITICAL RULES:
1. CROSS-REFERENCE the candidate's RESUME against their AUDIO PITCH. If the resume lists a skill/project but the candidate did NOT mention it in their audio pitch, flag it as a "Resume Gap".
...
Return ONLY a single valid JSON object:
{
  ...
  "feedback": {
    "positives": ["point1 with evidence", "point2 with evidence", "...8-10 total"],
    "improvements": ["point1 with action", "point2 with action", "...8-10 total"],
...
class HRModelInference:
    ...
    def load(self) -> bool:
        ...
        try:
            ...
            logger.info(f"📦 [HRModel] Loading base model: {BASE_MODEL}...")
            
            # BitsAndBytesConfig: Ye sabse important part hai.
            # load_in_4bit=True: Model ke w (weights) ko 4 guna chota kar deta hai.
            # Isse model 12GB VRAM wale GPU par asani se chalta hai.
